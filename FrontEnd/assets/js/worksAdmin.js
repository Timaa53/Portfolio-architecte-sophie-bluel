...
function figuresContentModal1() { // Création des figures de la modal-1 dans main
    ...
    // Création figure
    fetch('https://sophie-bluel-mlzc.onrender.com/api/works',)
    ...
    // Création bouton delete photos
            ...
            removeWorksBtn.addEventListener ("click", () => {
                    fetch(`https://sophie-bluel-mlzc.onrender.com/api/works/${figure.id}`, {
                        method: "DELETE",
                        headers: {
...
function formModal2() {
    ...
    fetch("https://sophie-bluel-mlzc.onrender.com/api/categories")
    .then(response => response.json())
    .then((data) => {
